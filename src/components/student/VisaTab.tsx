        ...
        <div className="lg:col-span-2 bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-xl shadow-slate-900/2 flex flex-col md:flex-row items-center gap-6 sm:gap-8 relative overflow-hidden">
          ...
          <div className="relative w-36 h-36 flex-shrink-0">
            <svg class="w-full h-full transform -rotate-90">
              <circle class="text-slate-100" cx="72" cy="72" fill="transparent" r="62" stroke="currentColor" strokeWidth="8"></circle>
              <circle class="text-emerald-500 transition-all duration-1000 ease-out" cx="72" cy="72" fill="transparent" r="62" stroke="currentColor" strokeDasharray="390" strokeDashoffset={390 - (390 * progressPercent) / 100} strokeLinecap="round" strokeWidth="8"></circle>
            </svg>
