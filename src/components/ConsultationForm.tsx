                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-1.5">
                      <label htmlFor="student-name" className="text-[11px] font-mono text-gray-400 uppercase tracking-wider block">Student Full Name</label>
                    ...
                    {/* Email */}
                    <div className="space-y-1.5">
                      <label htmlFor="student-email" className="text-[11px] font-mono text-gray-400 uppercase tracking-wider block">Email Address</label>
                      <div className="relative">
                    ...
                    <div className="space-y-1.5 md:col-span-2">
                      <label htmlFor="student-phone" className="text-[11px] font-mono text-gray-400 uppercase tracking-wider block">Mobile Number</label>
                      <div className="relative">
                    ...
                    {/* Dream Destination */}
                    <div className="space-y-1.5">
                      <label htmlFor="student-destination" className="text-[11px] font-mono text-gray-400 uppercase tracking-wider block">Dream Destination</label>
                      <div className="relative">
                    ...
                    {/* Target Study Track */}
                    <div className="space-y-1.5">
                      <label htmlFor="student-degree" className="text-[11px] font-mono text-gray-400 uppercase tracking-wider block">Target Study Track</label>
                      <div className="relative">
